...
# 達成期望查表（升壓 / 降壓;源 2021-2026 ladder × VIX>MA20 疊圖,VIX lag 1 因果版）
REACH_EXPECT = {
    "升壓": {"多L4": 0.30, "多L5": 0.16, "空L4": 0.30, "空L5": 0.17, "note": "深關卡 ~2× 頻繁：博長尾 EV 高、可抱久（方向中性,別用 VIX 偏多空）"},
    "降壓": {"多L4": 0.19, "多L5": 0.07, "空L4": 0.19, "空L5": 0.10, "note": "深關卡稀：早收 L3、別追 L4/L5"},
}
