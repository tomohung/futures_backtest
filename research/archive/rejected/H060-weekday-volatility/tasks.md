...
- [x] 計算每日三種振幅：日盤 H-L、夜盤 H-L、全日盤 H-L
- [x] 按星期幾分組，box plot 比較
- [x] Kruskal-Wallis 檢定（非參數，不假設常態）
- [x] 逐年分析穩定性（heat map: 年份 × 星期 × 中位振幅）
- [x] 排除結算日後重跑，確認效應非結算日驅動
- [x] 以振幅 / EMA(20) 標準化，消除市場波動水準差異
