...
**Fixed 1.0%**：`range_pct >= 1.0%`

曾嘗試 P67（當年前 1/3）作為相對門檻，但在極端年份（如 2026 年初高波動）門檻被拉到 1.87%，導致正常中高波動日被排除。Fixed 1.0% 跨年度更穩定，全期約 645 日（51%）。
...
- **CSV**：`specs/strategies/volatility_potential_days.csv`
